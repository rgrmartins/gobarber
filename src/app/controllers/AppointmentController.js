...
class AppointmentController {
  ...
  async delete(req, res) {
    ...
    // Verificando se o usuario que está cancelando é o dono do agendamento
    ...
    /**
     * Verificando se o cancelamento está pelo menos 2 horas do agendamento
     */
    // Retirando 2 horas da hora do agendamento
    const dateWithSub = subHours(appointment.date, 2);

    // Verificando se as 2 horas de antecedencia ja passou
